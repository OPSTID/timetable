        ...
        <IonGrid fixed>
          <IonListHeader class="ion-text-center">
            <IonLabel>
              <h1>
                <strong
                  style="font-weight: 900; font-size: 1.4em; color: #f3f8ff"
                  >Timetable</strong
                >
              </h1>
            </IonLabel>
          ...
          >
            <IonLabel
              style="color: white; opacity: 0.9; flex: 2"
              class="ion-padding"
            >
              <h1 style="font-weight: bold; font-size: 1.8em">
                大学生が本気で作った、<br />時間割アプリ
              </h1>
                  ...
                  <IonLabel>
                    <h3>
                      <IonText color="primary"
                        ><strong>すぐにできます！</strong></IonText
                      >
                    </h3>
                    <h2 class="ion-text-wrap">
                      <strong>インストールする</strong>
                    </h2>
                    <p>今すぐ使えます</p>
                  </IonLabel>
                </IonItem>
            ...
            <div class="ion-text-center" style="flex: 1">
              <img
                src="/img/screenshots/phone_20240404.png"
                class="fade-in"
                style="
                  border-radius: 30px;
                  max-height: 500px;
          ...
          <div class="ion-padding ion-text-center ion-hide-md-up">
            <IonLabel style="color: white; opacity: 0.9; font-size: 1.2em">
              <h1 style="font-weight: bold; font-size: ">
                大学生が本気で作った、<br />時間割アプリ
              </h1>
              <img
                src="/img/screenshots/phone_20240404.png"
      ...
      <IonGrid fixed id="detail">
        ...
        <IonList lines="none">
          ...
          <IonItem class="ion-padding-top">
            ...
            <IonLabel>
              <h1 class="ion-text-wrap">
                <strong>すぐに開始。広告課金なし</strong>
              </h1>
              <h3 class="ion-text-wrap">
                面倒くさいアカウント作成などはなく、すぐに始められます。(※ 1、※
                2)<br />また本サービスは、広告・課金無しで快適にご利用いただけます。(※
                3、※ 4)
              </h3>
            </IonLabel>
          </IonItem>
          ...
          <IonItem class="ion-padding-top">
            ...
            <IonLabel>
              ...
              <h3 class="ion-text-wrap">
                時間割管理機能にプラスし、他のアプリには（おそらく）ない、けど本当に必要な以下の機能を搭載。
              </h3>
            </IonLabel>
          </IonItem>
            ...
            <IonLabel>
              <h3 class="ion-text-wrap">
                <ul class="ion-text-wrap">
                  ...
                  <li>
                    パソコンでもスマホでも使える。QRコードで瞬時に授業転送。
                  </li>
                  <li>授業で使うWebサイトへのリンクを登録できる！</li>
                  <li>
                    2時限連続の授業など、複数の時限にある授業は、一回作成すればコピーできる（今後実装予定）
                  </li>
                  <li>オフライン対応、PWA対応</li>
                </ul>
                余計な機能ばかりの時間割アプリはやめて、Timetable
                を使ってみませんか？
              </h3>
            </IonLabel>
          </IonItem>
          ...
          <IonItem class="ion-padding-top">
            <IonLabel>
              ...
              <p class="ion-text-wrap">
                (※ 1)
                初期設定の際に、「利用規約」及び「プライバシーポリシー」をご確認、ご同意いただきます。
              </p>
              <p class="ion-text-wrap">
                (※ 2) すべてのデータがブラウザ内のデータ保存領域 (IndexedDB)
                に保存されます。
              </p>
              <p class="ion-text-wrap">
                (※ 3)
              ...
              <p class="ion-text-wrap">
                (※ 4)
                本サービス使用時に発生する通信費は、ユーザー様の負担となります。
              </p>
              <p class="ion-text-wrap ion-padding-top">
                ※
                実際に大学生が大学生活を送りながらワンオペで運営しています。そのため不具合の修正などに時間を要することがあります。
              </p>
              <p class="ion-text-wrap">
                ※
        ...
        <div class="ion-padding">
          ...
          >
            ...
            <IonLabel>
              ...
              <h2 class="ion-text-wrap"><strong>インストールする</strong></h2>
              <p>パソコンでも使えます</p>
            </IonLabel>
          </IonItem>
        </div>
        <div class="ion-text-center ion-padding">
          <IonLabel class="ion-text-wrap">
            <p>
              &copy; 2024-present
              <a href="https://x.com/OPSTIDTimetable" target="_blank">OPSTID</a>
            </p>
          </IonLabel>
          <IonLabel class="ion-text-wrap ion-margin-top">
            <p>
              LINEヤフー株式会社及び、Fontworks、Fontrix、LINE CREATIVE
              CENTERが制作した、<a
